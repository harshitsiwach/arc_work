...
import { SubmitBidPageContent } from "./content";

export default async function SubmitBidPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-lg mx-auto space-y-6 animate-fade-in-up">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold" style={{ color: "var(--color-fg)" }}>Submit Bid</h1>
      </div>
      <SubmitBidPageContent job={data.job} />
    </div>
  );
}
